...
class IOTests(TestFramework):
    ...
    def test_io_has_ipv6(self):
        ...
        try:
            amqpstorm3.io.socket.getaddrinfo = mock_getaddrinfo
            connection = FakeConnection()
            ...
            amqpstorm3.io.socket.getaddrinfo = restore_func

    def test_io_has_ipv6_is_false(self):
        restore_func = socket.getaddrinfo
        restore_has_ipv6 = amqpstorm3.io.socket.has_ipv6
        ...
        try:
            amqpstorm3.io.socket.getaddrinfo = mock_getaddrinfo
            amqpstorm3.io.socket.has_ipv6 = False
            connection = FakeConnection()
            connection.parameters['hostname'] = 'localhost'
            connection.parameters['port'] = 1234
            parameters = connection.parameters
            ...
            amqpstorm3.io.socket.getaddrinfo = restore_func
            amqpstorm3.io.socket.has_ipv6 = restore_has_ipv6
