...
from amqpstorm3 import compatibility
from amqpstorm3.compatibility import ssl
from amqpstorm3.compatibility import urlparse
from amqpstorm3.connection import Connection
from amqpstorm3.connection import DEFAULT_HEARTBEAT_TIMEOUT
from amqpstorm3.connection import DEFAULT_SOCKET_TIMEOUT
from amqpstorm3.connection import DEFAULT_VIRTUAL_HOST
...
class UriConnection(Connection):
    ...
    ::
        ...
        import amqpstorm3
        connection = amqpstorm3.UriConnection(
